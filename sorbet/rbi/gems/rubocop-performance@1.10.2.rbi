...
class RuboCop::Cop::Performance::RedundantBlockCall < ::RuboCop::Cop::Base
  ...
  # @return [Boolean]
  #
  # source://rubocop-performance//lib/rubocop/cop/performance/redundant_block_call.rb#96
...
#   items.all?(pattern)
#
# source://rubocop-performance//lib/rubocop/cop/performance/redundant_equality_comparison_block.rb#25
class RuboCop::Cop::Performance::RedundantEqualityComparisonBlock < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector
  extend ::RuboCop::Cop::TargetRubyVersion

  # source://rubocop-performance//lib/rubocop/cop/performance/redundant_equality_comparison_block.rb#37
  def on_block(node); end

  private

  # source://rubocop-performance//lib/rubocop/cop/performance/redundant_equality_comparison_block.rb#75
  def new_argument(block_argument, block_body); end

  # source://rubocop-performance//lib/rubocop/cop/performance/redundant_equality_comparison_block.rb#83
  ...
  # @return [Boolean]
  #
  # source://rubocop-performance//lib/rubocop/cop/performance/redundant_equality_comparison_block.rb#65
  def same_block_argument_and_is_a_argument?(block_body, block_argument); end

  # @return [Boolean]
  #
  # source://rubocop-performance//lib/rubocop/cop/performance/redundant_equality_comparison_block.rb#61
...
# source://rubocop-performance//lib/rubocop/cop/performance/redundant_equality_comparison_block.rb#31
RuboCop::Cop::Performance::RedundantEqualityComparisonBlock::MSG = T.let(T.unsafe(nil), String)

# source://rubocop-performance//lib/rubocop/cop/performance/redundant_equality_comparison_block.rb#33
...
class RuboCop::Cop::Performance::ReverseEach < ::RuboCop::Cop::Base
  ...
  # source://rubocop-performance//lib/rubocop/cop/performance/reverse_each.rb#34
  def on_send(node); end

  # source://rubocop-performance//lib/rubocop/cop/performance/reverse_each.rb#30
...
# source://rubocop-performance//lib/rubocop/cop/performance/reverse_each.rb#28
...
class RuboCop::Cop::Performance::Sum < ::RuboCop::Cop::Base
  ...
  # source://rubocop-performance//lib/rubocop/cop/performance/sum.rb#188
  ...
  # source://rubocop-performance//lib/rubocop/cop/performance/sum.rb#207
  def build_method_bad_method(init, method, operation); end

  # source://rubocop-performance//lib/rubocop/cop/performance/sum.rb#170
  def build_method_message(node, method, init, operation); end

  # source://rubocop-performance//lib/rubocop/cop/performance/sum.rb#181
  ...
  # source://rubocop-performance//lib/rubocop/cop/performance/sum.rb#232
  def method_call_with_args_range(node); end

  # source://rubocop-performance//lib/rubocop/cop/performance/sum.rb#166
  def sum_block_range(send, node); end

  # source://rubocop-performance//lib/rubocop/cop/performance/sum.rb#162
  def sum_map_range(map, sum); end

  # source://rubocop-performance//lib/rubocop/cop/performance/sum.rb#158
